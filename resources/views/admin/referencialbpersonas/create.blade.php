...
@stop
@section('content')
<form method="POST" action="{{ route('referencialbpersonas.store') }}">
  @csrf
  <div class="form-row">
    <div>
      <label for="id_referencia_laboral">Referencia laboral</label>
      <input class="form-control" id="id_referencia_laboral" type="text" name="id_referencia_laboral" id="id_referencia_laboral" value="{{old('id_referencia_laboral')}}">
    </div>
    <div>
  ...
  <div class="form-row">
    ...
    <div class="form-row">
      <div>
        ...
        <input class="form-control" id="telefono_empresa" type="text" name="telefono_empresa" value="{{old('telefono_empresa')}}">
      </div>
      <div>

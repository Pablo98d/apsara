...
<body>
    <div class="contenido-text">
        ...
        <label style="background: rgb(223, 223, 223); text-align: center; padding-bottom: 1px; width: 455px;margin-top: 10px" class="titulo-pdf">Solicitud de préstamos <br> <span style="font-size: 10px;">Director</span></label><br>
                    ...
                    @foreach ($prestamos as $prestamo)
                     <tr>
                        ...
                        <td style="font-weight: 900">
                             ...
                             @if ($contarp==0)
                                <small>
                                    <b style="font-size: 10px; font-weight: 900">N</b> 
                                </small>
                             @else
                             <small>
    ...
    <div class="contenido-text">
        ...
        @endphp
<img style=" position: absolute; z-index: 1; top: 17px; margin-right: 30px; float: right;"  src="{{asset('img/logo/Logo Prestamos.jpg')}}" width="125px" height="70px">
        <label style="background: rgb(223, 223, 223); text-align: center; padding-bottom: 1px; width: 455px; margin-top: 10px" class="titulo-pdf">Solicitud de préstamos <br> <span style="font-size: 10px;">Administrador</span></label><br>
        {{-- <img style="margin-left:105px; margin-bottom: 5px; z-index: -80; margin-top: 2px;"  src="{{asset('img/logoferiecita.png')}}" width="125px" height="50px"> --}}
        <label style="font-size: 9px; width: 150px; margin:0px;" for=""><b>Región:</b> {{$region->Plaza}}</label>
        <label style="font-size: 9px; width: 150px; margin:0px;" for=""><b>Ruta:</b> {{$zona->Zona}}</label>
        <label style="font-size: 9px; width: 150px; margin:0px;" for=""><b>Grupo:</b> {{$grupo->grupo}}</label><br>
        @if (count($gerente_zona)==0)
    ...
    <div class="contenido-text">
        ...
        @endphp
<img style=" position: absolute; z-index: 1; top: 17px; margin-right: 30px; float: right;"  src="{{asset('img/logo/Logo Prestamos.jpg')}}" width="125px" height="70px">
        <label style="background: rgb(223, 223, 223); text-align: center; padding-bottom: 1px; width: 455px; margin-top: 10px" class="titulo-pdf">Solicitud de préstamos <br> <span style="font-size: 10px;">Gerente de ruta</span></label><br>
        {{-- <img style="margin-left:105px; margin-bottom: 5px; z-index: -80; margin-top: 2px;"  src="{{asset('img/logoferiecita.png')}}" width="125px" height="50px"><br> --}}
        <label style="font-size: 9px; width: 150px; margin:0px;" for=""><b>Región:</b> {{$region->Plaza}}</label>
        <label style="font-size: 9px; width: 150px; margin:0px;" for=""><b>Ruta:</b> {{$zona->Zona}}</label>
        <label style="font-size: 9px; width: 150px; margin:0px;" for=""><b>Grupo:</b> {{$grupo->grupo}}</label><br>
        @if (count($gerente_zona)==0)

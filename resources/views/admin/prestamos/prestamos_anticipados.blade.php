...
@section('title', 'Solicitud de préstamos anticipados')
                ...
                <div class="col-md-3 mt-2 mb-1">
                    <div class="card-header d-flex">
                        ...
                        @else
                            ...
                            <a id="btn-imprimir" target="_blank" href="{{url('pdf-prestamo-anticipado/'.$region->IdPlaza.'/'.$zona->IdZona.'/'.$grupo->id_grupo)}}" class="btn btn-primary btn-sm" title="Imprimir recibo de préstamos anticipados"><i class="fas fa-print" ></i></a>
                            ...
                            <form id="entregarPrestamosForm" action="{{url('prestamo-entrega-anticipados/'.$region->IdPlaza.'/'.$zona->IdZona.'/'.$grupo->id_grupo)}}" method="post">
                                    @csrf
                       ...
                       @foreach ($prestamos as $prestamo)
                        <tr>
                           ...
                           <td style="font-weight: 900">
                                ...
                                @else
                                    <b style="font-size: 11px; font-weight: 900">LR

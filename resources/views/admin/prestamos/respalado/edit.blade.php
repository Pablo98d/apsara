  ...
  <form id="guardarCambiosPrestamoForm" method="POST" action="{{ url('prestamo/buscar-cliente/admin/prestamos/' .$prestamo->id_prestamo) }}" enctype="multipart/form-data">
      ...
      <div class="form-row mb-2">
        ...
        <div class="col-md-3">
          ...
          <select name="id_producto" class="form-control show-tick ms select2" id="id_producto" required data-placeholder="Select" required>
      ...
      <div class="form-row mb-2">
        <div class="col-md-4">
          ...
          <input type="text" class="form-control " name="cantidad" value="{{$prestamo->cantidad}}" placeholder="$2000.00" required>
        </div>
      </div>
    <div class="form-row">
      
      <button type="button" class="btn btn-primary mt-3 ml-2" data-toggle="modal" data-target="#guardarCambiosPrestamoModel" title="Guardar cambios" >Guardar cambios</button>

...
<div class="row">
    ...
    <h5 class="title">Socioeconómico {{$soci[0]->nombre_usuario}}</h5>
    </div>
        @if ( session('status') )
            <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        @else
                            ...
                            @php
                                ...
                                ->join('tbl_se_referencia_laboral','tbl_se_rl_personas.id_referencia_laboral','=','tbl_se_rl_personas.id_referencia_laboral')
                            ...
                            <form method="POST" action="{{ url('guardar-doc-aval') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" id="nombre" type="file" name="imagen">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                @foreach ($docs_ine_1 as $doc_ine_1)
                                    <div class="col-md-6">
                                        ...
                                        @else
                                                <img class="responsive-img materialboxed" src="https://pice-software.com/laferiecita/documentos/{{$doc_ine_1->path_url}}" style="border:1px solid #000" alt="Este es el ejemplo de un texto alternativo" width="400" height="240">  
                            ...
                            <div class="row">
                                @foreach ($docs_ine_2 as $doc_ine_2)
                                    <div class="col-md-6">
                                        ...
                                        @else
                                            <img class="responsive-img materialboxed" src="https://pice-software.com/laferiecita/documentos/{{$doc_ine_2->path_url}}" style="border:1px solid #000" alt="Este es el ejemplo de un texto alternativo" width="400" height="240">  
                                        @endif
                            ...
                            <div class="row">
                                @foreach ($docs_comprobante as $doc_comprobante)
                                    <div class="col-md-6">
                                        ...
                                        @else
                                            <img class="responsive-img materialboxed" src="https://pice-software.com/laferiecita/documentos/{{$doc_comprobante->path_url}}" style="border:1px solid #000" alt="Este es el ejemplo de un texto alternativo" width="400" height="450">  
                                        @endif
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                @foreach ($docs_perfil as $doc_perfil)
                                    <div class="col-md-6">
                                        ...
                                        @else
                                            <img class="responsive-img materialboxed" src="https://pice-software.com/laferiecita/documentos/{{$doc_perfil->path_url}}" style="border:1px solid #000" alt="Este es el ejemplo de un texto alternativo" width="350" height="450">
                                        @endif
                            ...
                            <div class="row">
                                @foreach ($docs_referencia as $doc_referencia)
                                    <div class="col-md-6">
                                        ...
                                        @else
                                            <img class="responsive-img materialboxed" src="https://pice-software.com/laferiecita/documentos/{{$doc_referencia->path_url}}" style="border:1px solid #000" alt="Este es el ejemplo de un texto alternativo" width="350" height="450">  
                                        @endif
                        ...
                        @if ($doc_ine_1[0]->doc_total_ine_1==0)
                            <form method="POST" action="{{ url('guardar-doc-aval') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3" style="border-bottom: 1px solid #000; color: #000">
                                        <center>
                                            Cargar aquí las imágenes del INE
                                        </center>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="hidden" name="id_socio_economico" value="{{$soci[0]->id_socio_economico}}">
                            ...
                            <div class="row">
                                @foreach ($docs_ine_1 as $doc_ine_1)
                                    <div class="col-md-6">
                                        ...
                                        @else
                                            <img class="responsive-img materialboxed" src="https://pice-software.com/laferiecita/documentos/{{$doc_ine_1->path_url}}" style="border:1px solid #000; border-radius: 6px;" alt="Este es el ejemplo de un texto alternativo" width="400" height="240">  
                                        @endif
                                    </div>
                                    <div class="col-md-6">
                                        <form method="POST" action="{{ url('update-doc/'.$doc_ine_1->id_documento)}}" enctype="multipart/form-data">
                ...
                @else
                    ...
                    <div class="col-md-3">
                        <form action="{{url('aprobacion-socioeconomico')}}" method="post">
                            @csrf
                            <input type="hidden" name="id_préstamo" value="{{$prestamo_socio[0]->id_prestamo}}">
                            <center>

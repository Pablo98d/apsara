    ...
    <div class="col-md-12">
        <div class="tabContainer">
            <div class="buttonContainer">
                ...
                <button onclick="showPanel(12,'white')">Terminación</button>
            </div>
            <div class="tabPanel">
        ...
        <div class="row">
            ...
            @if($usuario_tipo==6)
                ...
                @if (count($prestamo_socio)==0)
                    No hay ningun préstamo
                @else
                    @if ($prestamo_socio[0]->estatus==100)
                        @if ($prestamo_socio[0]->id_status_prestamo==1)
                            <div class="col-md-6"></div>
                            <div class="col-md-3">
                                <form action="{{url('analista-aprobar-socio')}}" method="post">
                                    @csrf
                            ...
                            <div class="col-md-3">
                                <form action="{{url('analista-negar-socio')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="id_préstamo" value="{{$prestamo_socio[0]->id_prestamo}}">
                                    <center>
                        ...
                        @elseif($prestamo_socio[0]->id_status_prestamo==10)
                            <div class="col-md-12">
                                <center>
                                    <span class="badge badge-success">Socioeconómico aprobado</span>
                                </center>
                            </div>
                        @elseif($prestamo_socio[0]->id_status_prestamo==11)
                            <div class="col-md-12">
                                <center>
                                    <span class="badge badge-danger">Socioeconómico fue negado</span>
                                </center>
                            </div>
                        @endif
